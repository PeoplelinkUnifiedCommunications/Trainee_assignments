...
function Images() {
  ...
  return(
      <div className='exapand-app-container'>
          <div className={click ? `active` : `inactive`} onClick={expandCard} style={{backgroundImage: `url("https://www.desktopbackground.org/download/1280x1024/2011/01/28/149250_top-photography-nature-hd-background-images-for-pinterest_1920x1080_h.jpg")`}}>
              <h3 className={click ? `after` : `before`}>Leaf Image</h3>
          </div>
