    ...
    <div className="flexCol resume">
      ...
      <div className="coretechs">
        ...
        <div className="technologies">
          <span className="tech1">HTML5, CSS3,</span>
          <br />
          <span className="tech2">CSS-in-JS</span>
          <br />
        ...
        <div className="othertechs">
          <span>Others:</span>
          <br />
          <span className="tech1">Design Systems, PWAs</span>
          <br />
          <span className="tech2">Software Testing</span>
          <br />
      ...
      <div className="experience">
        ...
        <div className="res-projects">
          <span className="projects-res">
            Links to some of my work can be found on <br />
            <Link to={"/work"}>marti.dev/work</Link>
          </span>
        </div>
        <br />
        <br />
