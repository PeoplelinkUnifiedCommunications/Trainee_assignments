    ...
    return(
        <div className='menu-bg-container'>
            <div className='menu-header'>
                <h1>Olaolu</h1>
                <a href='/shelf'><GiTireIronCross/></a>
            </div>
            <div className='menu-hello-part'>
            
             <ul className='menu-work-part-bg'>
                 <li className='list-item-footer-part'>
                    <a  className="anchor-element-style" href='/'><button className='anchor-button' type='button'>Home</button></a></li>
                 <li className='list-item-footer-part'><a  className="anchor-element-style" href='/work'><button className='anchor-button' type='button'>My Work</button></a></li>
