...
const port = 8000;
const URL = "mongodb+srv://krishna:Krishna4377@crud.emxdl.mongodb.net/CRUDAPP?retryWrites=true&w=majority"

const db = async() =>{
    await mongoose.connect(URL).then(()=>{
        app.listen(port, ()=>{
            console.log(`surver is running successfully on port ${port}`)
        })
    })
}
